...
function loadVehicleProfileDetail(id) {
    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            ...
            $("#supIDValue").val(data.suplire.supid);
...
//                    + "<td><input type='button' class='btn btn-xs btn-info '  value='EDIT' onclick='editService(" + x + ")' /></td>"
                    + "<td><input type='button' class='btn btn-xs btn-success '  value='View' onclick='viewServiceModal(" + x + ");' /></td>"
                    + "<td><input type='button' class='btn btn-xs btn-danger '  value='DELETE' onclick='vehicleDeleteButtonClickd(" + x + ");' /></td>"
                    + "</tr>";
        });
