...
<html lang="en">
    <head>
        ...
        <title>Auto Support Service(Pvt) LTD | Vehicle Profile - Supplier</title>
    ...
    <body>
                ...
                <section class="wrapper">
                    <div class="row">
                        <div class="col-md-12 main-chart">
                            ...
                            <script src="implementation/js/vehical-profile-operation-supplier.js"></script> 
                            ...
                            <!--Vehicle-Delete Check model--> 
                            <%@include file="divLoad/vehicle/vehicle-deleteCheck-modal.jsp" %>
        ...
        <script src="implementation/js/customer-operation-supplier.js"></script> 
        <script src="implementation/js/vehical-operation-supplier.js"></script>  
