...
<html lang="en">
    <head>
        ...
        <title>Auto Support Service(Pvt) LTD | Services Provider</title>
                ...
                <section class="wrapper">
                    <div class="row">
                        <div class="col-md-12 main-chart">
                            <!-- customer container-->
                            <%@include file="divLoad/provider/provider-header.jsp" %>
                            <%@include file="divLoad/provider/services-provider-add-modal.jsp" %>

                            <script src="implementation/js/servicesprovider.js"></script>
                            <%@include file="divLoad/provider/services-of-servicesproviders-add-modal_Shortcut.jsp" %>
