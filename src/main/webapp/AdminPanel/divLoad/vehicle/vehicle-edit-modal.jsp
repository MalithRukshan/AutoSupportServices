...
<div class="modal fade" id="vechicleEditModal" tabindex="-1"
        ...
        <div class="modal-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-offset-1 col-md-3">
                            <label for="vechicle-type"
                                   class="control-label margin-top-10">Select Type</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="VoperationSelection"
                        onclick="updateVehicleDetails();" value="vadd">Vehicle</button>
            </div>
        </div>
    </div>
</div>
