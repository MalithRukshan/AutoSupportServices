...
<input type="hidden" id="operationSelection" /><!--for select whether add or edit-->
        ...
        <div class="modal-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-offset-1 col-md-8">
                            <label for="password"
                                   ...
                                   type="password" class="form-control" id="password"  disabled/>
                        </div> 
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="add-customer"
                        onclick="updateCustomerDetails();" value="">Edit Customer</button>
